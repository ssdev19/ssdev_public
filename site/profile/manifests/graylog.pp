...
# Install OpenSearch repository and packages
  ...
  ->class { 'graylog::server':
    ...
    config          => {
      ...
      http_tls_cert_file                  => '/etc/ssl/certs/graylog/graylog_ssdev.crt',
      http_tls_key_file                   => '/etc/ssl/certs/graylog/graylog_ssdev.key',
    ...
    java_opts       => '-Xms1g -Xmx1g -Djavax.net.ssl.trustStore=/usr/share/graylog-server/jvm/lib/security/cacerts',
  }
